    ...
    equiposTable = $("#equipos-table").DataTable({
      ...
      buttons: [
        ...
        },
        {
          ...
          exportOptions: {
            columns: [1, 2, 3, 4, 5, 6, 7], // Excluye la columna de acciones
          },
            ...
            if (tableIndex !== -1) {
              ...
              doc.content[tableIndex].table.body.forEach((row, i) => {
                if (i === 0) {
                  ...
                  // Filas de datos
                  const estado = row[2].text.toString().toLowerCase(); // Columna 'estado'
                  ...
                  if (i % 2 === 0) {
                    row.forEach((cell, j) => {
                      if (j !== 2 && !cell.fillColor) { // No sobrescribir el color de estado
